...
import { CallToolRequestSchema, ListPromptsRequestSchema, ListToolsRequestSchema, ListResourcesRequestSchema, ReadResourceRequestSchema, } from "@modelcontextprotocol/sdk/types.js";
        ...
        tools: [
            {
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        expiration: {
                            type: "string",
                            description: "The expiration date to find options chains for formatted as YYYY-MM-DD",
                        },
                        greeks: {
                            type: "boolean",
                        ...
                        strike_percentage: {
                            type: "number",
                            description: "The percentage of the current price to filter strikes by",
                            default: 10,
                            optional: true,
                        },
                    },
            ...
            },
            {
                ...
                description: "Query the Tradier API to find historical prices for a given symbol or option contract on in a given time range",
                inputSchema: {
                    type: "object",
                    properties: {
                        symbol: {
                            type: "string",
                            description: "The symbol to find historical prices for either a stock or an option contract. You can fetch historical pricing for options by passing the OCC option symbol (ex. AAPL220617C00270000) as the symbol. Use longer intervals for longer time ranges.",
                        },
                        interval: {
                            type: "string",
                            description: "Interval of time per timesale. One of: daily, weekly, monthly",
                            enum: ["daily", "weekly", "monthly"],
                            default: "daily",
                        },
                        start: {
                            type: "string",
                            description: "The start date of the time range to fetch historical prices for in YYYY-MM-DD format",
                        },
                        end: {
                            type: "string",
                            description: "The end date of the time range to fetch historical prices for in YYYY-MM-DD format",
                        },
                        session_filter: {
                            type: "string",
                            description: "Specify to retrieve aggregate data for all hours of the day (all) or only regular trading sessions (open).",
                            enum: ["all", "open"],
                            default: "all",
                            optional: true,
                        },
...
function testSignificantStrikePrices() {
    ...
    const significantStrikes = filterSignificantStrikePrices(underlyingPrice, percentage, strikePrices);
    ...
    const reductionPct = ((strikePrices.length - significantStrikes.length) / strikePrices.length) *
        100;
